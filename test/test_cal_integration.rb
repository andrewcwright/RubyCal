...
class TestCalIntegration < Test::Unit::TestCase
  ...
  def test_03_output_of_31_day_month_non_leap_year
    assert_equal(`cal 1 2013`, `ruby RubyCal.rb 1 2013`)
  end

  def test_04_output_of_February_on_non_leap_year
    assert_equal(`cal 2 2013`, `ruby RubyCal.rb 2 2013`)
  end

  def test_05_output_of_30_day_month_on_non_leap_year
    assert_equal(`cal 4 2013`, `ruby RubyCal.rb 4 2013`)
  end

  def test_06_output_of_31_day_month_on_4x_leap_year
    assert_equal(`cal 1 2012`, `ruby RubyCal.rb 1 2012`)
  end

  def test_07_output_of_February_on_4x_leap_year
    assert_equal(`cal 2 2012`, `ruby RubyCal.rb 2 2012`)
  end

  def test_08_output_of_30_day_month_on_4x_leap_year
    assert_equal(`cal 4 2012`, `ruby RubyCal.rb 4 2012`)
  end

  def test_09_output_of_31_day_month_on_100x_leap_year
    assert_equal(`cal 1 2200`, `ruby RubyCal.rb 1 2200`)
  end

  def test_10_output_of_February_on_100x_leap_year
    assert_equal(`cal 2 2200`, `ruby RubyCal.rb 2 2200`)
  end

  def test_11_output_of_30_day_month_on_100x_leap_year
    assert_equal(`cal 4 2200`, `ruby RubyCal.rb 4 2200`)
  end

  def test_12_output_of_31_day_month_on_400x_leap_year
    assert_equal(`cal 1 2000`, `ruby RubyCal.rb 1 2000`)
  end

  def test_13_output_of_February_on_400x_leap_year
    assert_equal(`cal 2 2000`, `ruby RubyCal.rb 2 2000`)
  end

  def test_14_output_of_30_day_month_on_400x_leap_year
